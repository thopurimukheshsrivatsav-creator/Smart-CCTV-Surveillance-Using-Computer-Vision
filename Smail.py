...
def send_email(message,image_filename,default_email = "thopurimukheshsrivatsav@gmail.com"):
    sender_email = "thopurimukheshsrivatsav@gmail.com"  
    sender_password = "zggx xdat kmgf sqvr"
    subject = "Smart CCTV"
